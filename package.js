...
Package.onUse(function(api) {
  ...
  api.use('check');
  // client
  api.use(['livedata', 'underscore', 'deps', 'templating', 'ui', 'blaze', 'ejson', 'reactive-var', 'reactive-dict'], 'client');
  ...
  api.addFiles([
    ...
    'templates/bootstrap3/inputTypes/boolean-select/boolean-select.js',
    ...
    'templates/bootstrap3/inputTypes/select/select.js',
